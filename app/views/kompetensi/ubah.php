...
<a href="<?= BASEURL ?>/skema/detail/<?= $data['nama-skema'] ?>/<?= $data['level-skema'] ?>" class="btn btn-outline btn-warning my-5">Back</a>
...
<div class="container-form w-full h-fit mb-4">
  <form action="<?= BASEURL ?>/skema/edit_kompetensi/<?= $data['id-kompetensi'] ?>/<?= $data['nama-skema'] ?>/<?= $data['level-skema'] ?>" method="post" class="w-full" enctype="multipart/form-data">
      ...
      <div class="left-form w-1/2">
        <div class="form-control w-[500px]">
          <label class="label" for="nama-kompetensi">
            <span class="label-text text-lg font-semibold">Nama Kompetensi</span>
          </label>
        ...
        <div class="form-control w-[500px] mt-4">
          <label class="label" for="pelaksanaan">
            <span class="label-text text-lg font-semibold">Jenis Pelaksanaan</span>
          </label>
        ...
        <div class="waktu w-[500px] mt-4 flex flex-wrap justify-between items-center">
          <div class="form-control w-[240px]">
            <label class="label" for="jam-mulai">
              <span class="label-text text-lg font-semibold">Mulai Ujian</span>
            </label>
            <input type="time" value="<?= $data['list-kompetensi']['jam_mulai']; ?>" placeholder="" class="input input-bordered" id="jam-mulai" name="jam-mulai" />
          </div>
          <div class="form-control w-[240px]">
            <label class="label" for="jam-akhir">
              <span class="label-text text-lg font-semibold">Selesai Ujian</span>
            </label>
            <input type="time" value="<?= $data['list-kompetensi']['jam_akhir']; ?>" placeholder="" class="input input-bordered" id="jam-akhir" name="jam-akhir" />
          </div>
        </div>
      </div>
      <div class="right-form w-1/2">
        <div class="form-control w-full">
          <label class="label" for="tgl-kompetensi">
            <span class="label-text text-lg font-semibold">Tanggal Ujian</span>
          </label>
        ...
        <div class="form-control w-full mt-4">
          <label class="label" for="tempat-kompetensi">
            <span class="label-text text-lg font-semibold">Tempat Ujian Kompetensi</span>
          </label>
        ...
        <div class="form-control w-full mt-4">
          ...
          <input type="file" value="<?= $data['list-kompetensi']['file_opsional']; ?>" placeholder="" class="input" id="soal-kompetensi" name="soal-kompetensi" />
        </div>
      </div>
    </div>
