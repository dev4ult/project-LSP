    ...
    <div class="p-8 pt-14">
        ...
        <div class="my-3">
            <div class="w-full">
                ...
                <?php if ($data['status-pendaftaran']) : ?>
                <div class="text-right">
                    <a href="<?= BASEURL ?>/asesi/form_upload_document/<?= $data['id-skema'] ?>" name="update"
                        type="button" class="btn btn-primary rounded-sm my-5 mt-8 text-white w-full">unggah dokumen</a>
                </div>
                <?php else : ?>

                <form action="<?= BASEURL ?>/asesi/daftar/<?= $data['id-skema'] ?>" method="post">
                    <div class="text-right">
                        <button type="submit" name="update"
                            class="btn btn-primary rounded-sm my-5 mt-8 text-white w-full">daftar</button>
                    </div>
                </form>
                <?php endif; ?>
